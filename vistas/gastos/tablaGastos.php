...
<table class="table table-bordered" style="background-color:white" id="datatableGastos">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="../../procesos/gastos/eliminarGasto.php" method="POST">
                    <input type="text" hidden name="idGasto" value="<?php echo $mostrar['categoria']?>">
                    <button  class="btn btn-danger">Eliminar <span class="fas fa-dumpster-fire"></span></button>
                </form>
            </td>
        </tr>
        <?php
